...
public class etapa3 {
    ...
    // Contador para rastrear o número de multiplicações
    ...
    public static void main(String[] args) {
        ...
        // Imprime o número total de multiplicações
        System.out.println("Número total de multiplicações realizadas: " + multiplicacaoCount);
    }
        ...
        for (int i = 0; i < a.length; i++) {
            for (int j = 0; j < b[0].length; j++) {
                for (int k = 0; k < b.length; k++) {
                    ...
                    multiplicacaoCount++; // Incrementa o contador de multiplicação
                }
            }
        }
